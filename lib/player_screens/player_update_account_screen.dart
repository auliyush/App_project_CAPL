...
class PlayerUpdateAccountScreen extends StatefulWidget {
  ...
  const PlayerUpdateAccountScreen({
    Key? key,
  ...
  @override
  _PlayerUpdateAccountScreenState createState() => _PlayerUpdateAccountScreenState();
}

class _PlayerUpdateAccountScreenState extends State<PlayerUpdateAccountScreen> {
