...
import 'package:merge_capl/stats/stats_card_page.dart';
import '../adminScreens/admin_bottom_nav.dart';
      ...
      // stats filter button
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => FloatSeasonScreen()),
            );
          },
          child: const Icon(
            Icons.list,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          // record button (this button is navigate this page)
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => const Stats(
                                          ...
                                          playersProfileUrl:
                                              'assets/images/rohitsharma.webp',
                                          position: '01',
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Colors
                                .blue, // This color will show as a fallback if the image is not loaded
                          ),
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.circular(
                                              12.0), // Add borderRadius for rounded corners
                                        ),
                                        child: Column(
                                          mainAxisAlignment:
                              ...
                              Column(
                                children: [
                                  for (PlayerLists players in _foundPlayers)
                                    PlayerListRank(playerLists: players)
                                ],
                              )
                            ],
                          ),
