...
import 'package:merge_capl/aman/audience/audience_more.dart';
...
class AudienceBottom extends StatefulWidget {
  @override
  _AudienceBottomState createState() => _AudienceBottomState();
}

class _AudienceBottomState extends State<AudienceBottom> with SingleTickerProviderStateMixin {
  int _currentIndex = 0;
  ...
  final List<Widget> _tabs = [
    ...
    AudienceMoreScreen(),// audience more screen
  ];
