...
import '../../ayush/about_us.dart';
import '../../ayush/account_screen.dart';
import '../../ayush/feedback_screen.dart';
import '../../tournament.dart';


class AudienceMoreScreen extends StatefulWidget {
  const AudienceMoreScreen({super.key});

  @override
  State<AudienceMoreScreen> createState() => _MorePageState();
}

class _MorePageState extends State<AudienceMoreScreen> {
  @override
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AudienceAccountPage(
