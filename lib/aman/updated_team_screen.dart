...
class UpdatedTeamScreen extends StatefulWidget {

  @override
  State<UpdatedTeamScreen> createState() => _TeamScreenState();
}

class _TeamScreenState extends State<UpdatedTeamScreen> {
  @override
